...
public class Cave extends Maps{
    public Cave() {
        super("Yankı Mağaraları", 150, "Ateşlenen Kristal"); // mapName'i "Yankı Mağaraları" olarak güncelledim
    }

    @Override
    public void teleport(Character player) {
        player.setLocation(this.getMapName()); // Oyuncunun konumunu güncelle
        this.setMonsterCount(new Random().nextInt(3) + 2); // 2-4 arası canavar
        Monster monster = new Golem();
        System.out.println("\n\n\n\n\n\n\n\n\n\n\n");
